...
def process_all_log_files():
    ...
    print(f"file path, sdimacs, lowCpog, upCpog")
    for file_path in log_files:
        sdimacs, lowCpog, upCpog = extract_size(file_path)
        if sdimacs is not None:
            print(f"{file_path}, {sdimacs}, {lowCpog}, {upCpog}")
        else:
